<x-app-layout>
    <x-slot name="title">Top Up Saldo | Dompet Trinexa</x-slot>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="mb-10 text-center md:text-left">
                <h1 class="text-4xl md:text-5xl font-black text-[var(--tx-text-dark)] mb-3 flex items-center md:justify-start justify-center gap-3">
                    <span class="text-5xl drop-shadow-sm">💳</span> Top Up Saldo
                </h1>
                <p class="text-sm font-bold text-[var(--tx-text-muted)] uppercase tracking-widest">Tambah saldo Trinexa-mu secara instan untuk belanja lebih mudah</p>
            </div>
            ...
            <form action="{{ route('user.wallet.processTopup') }}" method="POST"
                  x-data="{
                      selected: 0,
                      custom: '',
                      method: '',
                      ...
                      get balanceAfter() {
                          return {{ $wallet->balance }} + this.finalAmount;
                      },
                      get canSubmit() {
                          return this.finalAmount >= 10000 && this.method !== '';
                      },
                      formatRp(n) {
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <div class="lg:col-span-2 space-y-10">
                        ...
                        <div class="glass-card bg-white/40 rounded-[2.5rem] p-8 border border-white/60 shadow-sm backdrop-blur-xl relative overflow-hidden">
                            ...
                            <div class="flex items-center gap-3 mb-6 relative z-10">
                                ...
                                <h2 class="text-xl font-black text-[var(--tx-text-dark)] uppercase tracking-widest">Pilih Nominal</h2>
                            </div>
                            
                            <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6 relative z-10">
                                @foreach([50000, 100000, 200000, 500000, 1000000, 2000000] as $preset)
                                    <button type="button"
                                            @click="selectPreset({{ $preset }})"
                                            :class="selected === {{ $preset }} && !custom ? 'border-transparent bg-gradient-to-r from-[var(--tx-primary)] to-[var(--tx-secondary)] text-white shadow-lg shadow-[var(--tx-primary)]/30 -translate-y-1' : 'border-white/80 bg-white/60 text-[var(--tx-text-muted)] hover:border-[var(--tx-primary)] hover:text-[var(--tx-primary)] hover:-translate-y-1 hover:shadow-md'"
                        ...
                        <div class="glass-card bg-white/40 rounded-[2.5rem] p-8 border border-white/60 shadow-sm backdrop-blur-xl relative overflow-hidden">
                            ...
                            <div class="flex items-center gap-3 mb-6 relative z-10">
                                ...
                                <h2 class="text-xl font-black text-[var(--tx-text-dark)] uppercase tracking-widest">Pilih Metode</h2>
                            </div>
                            ...
                            <div class="space-y-3 relative z-10">
                                ...
                                <label class="cursor-pointer block group">
                                    <input type="radio" x-model="method" value="qris" class="sr-only peer">
                                    <div class="flex items-center gap-5 p-5 rounded-2xl border-2 transition-all
                                                peer-checked:border-[#EF3340] peer-checked:bg-white peer-checked:shadow-lg
                                                border-white/60 hover:border-white bg-white/50 backdrop-blur-md">
                                        <div class="w-16 h-10 shrink-0 flex items-center justify-center bg-white rounded-xl shadow-sm border border-gray-100">
                                            <svg viewBox="0 0 120 40" class="w-full h-full p-1">
                                                <!-- Q -->
                                                <text x="4" y="28" font-family="Arial Black, sans-serif" font-size="22" font-weight="900" fill="#EF3340">Q</text>
                                                <!-- RIS -->
                                                <text x="26" y="28" font-family="Arial Black, sans-serif" font-size="22" font-weight="900" fill="#EF3340">R</text>
                                                <text x="44" y="28" font-family="Arial, sans-serif" font-size="22" font-weight="900" fill="#231F20">IS</text>
                                                <!-- QR dots decoration -->
                                                <rect x="84" y="6" width="4" height="4" rx="1" fill="#EF3340"/>
                                                <rect x="90" y="6" width="4" height="4" rx="1" fill="#EF3340"/>
                                                <rect x="96" y="6" width="4" height="4" rx="1" fill="#EF3340"/>
                                                <rect x="102" y="6" width="4" height="4" rx="1" fill="#EF3340"/>
                                                <rect x="108" y="6" width="4" height="4" rx="1" fill="#EF3340"/>
                                                <rect x="84" y="12" width="4" height="4" rx="1" fill="#231F20"/>
                                                <rect x="102" y="12" width="4" height="4" rx="1" fill="#231F20"/>
                                                <rect x="84" y="18" width="4" height="4" rx="1" fill="#231F20"/>
                                                <rect x="96" y="18" width="4" height="4" rx="1" fill="#EF3340"/>
                                                <rect x="102" y="18" width="4" height="4" rx="1" fill="#231F20"/>
                                                <rect x="84" y="24" width="4" height="4" rx="1" fill="#231F20"/>
                                                <rect x="102" y="24" width="4" height="4" rx="1" fill="#231F20"/>
                                                <rect x="84" y="30" width="4" height="4" rx="1" fill="#EF3340"/>
                                                <rect x="90" y="30" width="4" height="4" rx="1" fill="#EF3340"/>
                                                <rect x="96" y="30" width="4" height="4" rx="1" fill="#EF3340"/>
                                                <rect x="102" y="30" width="4" height="4" rx="1" fill="#EF3340"/>
                                                <rect x="108" y="30" width="4" height="4" rx="1" fill="#EF3340"/>
                                            </svg>
                                        </div>
                                        <div class="flex-1">
                                            <p class="font-black text-[var(--tx-text-dark)] text-sm mb-1 group-hover:text-[#EF3340] transition-colors">QRIS</p>
                                            <p class="text-[11px] font-bold text-[var(--tx-text-muted)] uppercase tracking-widest">Scan QR dari semua e-wallet</p>
                                        </div>
                                        <div class="w-6 h-6 rounded-full border-[3px] border-white/80 peer-checked:border-[#EF3340] flex items-center justify-center shrink-0 transition-all bg-white shadow-inner" :class="method === 'qris' ? 'border-[#EF3340]' : 'border-gray-300'">
                                            <div class="w-3 h-3 rounded-full bg-[#EF3340] transition-all" :class="method === 'qris' ? 'opacity-100 scale-100' : 'opacity-0 scale-50'"></div>
                                        </div>
                                    </div>
                                </label>
                                ...
                                {{-- GoPay --}}
                                <label class="cursor-pointer block group">
                                    <input type="radio" x-model="method" value="gopay" class="sr-only peer">
                                    <div class="flex items-center gap-5 p-5 rounded-2xl border-2 transition-all
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-[11px] font-bold text-[var(--tx-text-muted)] uppercase tracking-widest">Dompet digital Gojek</p>
                                        </div>
                                        <div class="w-6 h-6 rounded-full border-[3px] border-white/80 peer-checked:border-[#00AED6] flex items-center justify-center shrink-0 transition-all bg-white shadow-inner" :class="method === 'gopay' ? 'border-[#00AED6]' : 'border-gray-300'">
                                            <div class="w-3 h-3 rounded-full bg-[#00AED6] transition-all" :class="method === 'gopay' ? 'opacity-100 scale-100' : 'opacity-0 scale-50'"></div>
                                        </div>
                                    </div>
                                </label>
                                ...
                                {{-- OVO --}}
                                <label class="cursor-pointer block group">
                                    <input type="radio" x-model="method" value="ovo" class="sr-only peer">
                                    <div class="flex items-center gap-5 p-5 rounded-2xl border-2 transition-all
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-[11px] font-bold text-[var(--tx-text-muted)] uppercase tracking-widest">Dompet digital OVO</p>
                                        </div>
                                        <div class="w-6 h-6 rounded-full border-[3px] border-white/80 peer-checked:border-[#4C3494] flex items-center justify-center shrink-0 transition-all bg-white shadow-inner" :class="method === 'ovo' ? 'border-[#4C3494]' : 'border-gray-300'">
                                            <div class="w-3 h-3 rounded-full bg-[#4C3494] transition-all" :class="method === 'ovo' ? 'opacity-100 scale-100' : 'opacity-0 scale-50'"></div>
                                        </div>
                                    </div>
                                </label>
                                ...
                                {{-- DANA --}}
                                <label class="cursor-pointer block group">
                                    <input type="radio" x-model="method" value="dana" class="sr-only peer">
                                    <div class="flex items-center gap-5 p-5 rounded-2xl border-2 transition-all
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-[11px] font-bold text-[var(--tx-text-muted)] uppercase tracking-widest">Dompet digital DANA</p>
                                        </div>
                                        <div class="w-6 h-6 rounded-full border-[3px] border-white/80 peer-checked:border-[#108EE9] flex items-center justify-center shrink-0 transition-all bg-white shadow-inner" :class="method === 'dana' ? 'border-[#108EE9]' : 'border-gray-300'">
                                            <div class="w-3 h-3 rounded-full bg-[#108EE9] transition-all" :class="method === 'dana' ? 'opacity-100 scale-100' : 'opacity-0 scale-50'"></div>
                                        </div>
                                    </div>
                                </label>
                                ...
                                {{-- Bank Transfer --}}
                                <label class="cursor-pointer block group">
                                    <input type="radio" x-model="method" value="bank" class="sr-only peer">
                                    <div class="flex items-center gap-5 p-5 rounded-2xl border-2 transition-all
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-[11px] font-bold text-[var(--tx-text-muted)] uppercase tracking-widest">BCA · Mandiri · BNI · BRI</p>
                                        </div>
                                        <div class="w-6 h-6 rounded-full border-[3px] border-white/80 peer-checked:border-[var(--tx-primary)] flex items-center justify-center shrink-0 transition-all bg-white shadow-inner" :class="method === 'bank' ? 'border-[var(--tx-primary)]' : 'border-gray-300'">
                                            <div class="w-3 h-3 rounded-full bg-[var(--tx-primary)] transition-all" :class="method === 'bank' ? 'opacity-100 scale-100' : 'opacity-0 scale-50'"></div>
                                        </div>
                                    </div>
                                </label>
                    ...
                    <div class="lg:col-span-1">
                        <div class="sticky top-24 space-y-6">
                            ...
                            {{-- Saldo Saat Ini --}}
                            <div class="glass-card bg-gradient-to-br from-[var(--tx-primary)] to-[#2D3F5A] rounded-[2.5rem] p-8 border border-white/20 shadow-[0_20px_40px_rgba(15,41,66,0.3)] relative overflow-hidden group">
                            ...
                            <div x-show="finalAmount > 0" x-cloak 
                                ...
                                <div class="flex justify-between items-center mb-4 border-b border-white/80 pb-4">
                                    <p class="text-[10px] font-black text-[var(--tx-text-muted)] uppercase tracking-widest">Jumlah Top Up</p>
                                    <p class="font-black text-[var(--tx-text-dark)] text-lg" x-text="formatRp(finalAmount)"></p>
                                </div>
                                <div class="flex justify-between items-center">
                                    <p class="text-[10px] font-black text-[var(--tx-primary)] uppercase tracking-widest">Total Saldo (Est)</p>
                            ...
                            <button type="submit"
                                ...
                                <div class="relative z-10 flex items-center justify-center gap-2">
                                    <span x-show="canSubmit">Konfirmasi Top Up ✨</span>
                                    <span x-show="!canSubmit && finalAmount < 10000">Pilih Nominal 🔒</span>
                                    <span x-show="!canSubmit && finalAmount >= 10000 && !method">Pilih Metode Pembayaran 🔒</span>
                                </div>
                            </button>
